...
async function main() {
    const SandwichBotV2 = await ethers.getContractFactory("SandwichBotV2");
    ...
    const sandwichBotV2 = await SandwichBotV2.deploy(wbnb,factory,ops);
    console.log("sandwichBot Contract deployed to address:", sandwichBotV2.address);
 }
